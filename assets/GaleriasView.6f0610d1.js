import{_ as Ot,r as Be,o as re,c as se,a as b,w as xt,F as Bt,g as Pt,p as Nt,h as Ut}from"./index.1a75d287.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(yn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function yn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const me="@firebase/app",$e="0.8.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(t){V(new F("platform-logger",e=>new wn(e),"PRIVATE")),V(new F("heartbeat",e=>new tr(e),"PRIVATE")),k(me,$e,t),k(me,$e,"esm2017"),k("fire-js","")}sr("");var or="firebase",ir="9.13.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=w.makeFromUrl(e,n)}catch{return new w(e,"")}if(r.path==="")return r;throw Or(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function o(E){E.path.charAt(E.path.length-1)==="/"&&(E.path_=E.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+s+i,"i"),c={bucket:1,path:3};function l(E){E.path_=decodeURIComponent(E.path)}const f="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),g="(/([^?#]*).*)?$",m=new RegExp(`^https?://${p}/${f}/b/${s}/o${g}`,"i"),I={bucket:1,path:3},$=n===mt?"(?:storage.googleapis.com|storage.cloud.google.com)":n,y="([^?#]*)",M=new RegExp(`^https?://${$}/${s}/${y}`,"i"),T=[{regex:a,indices:c,postModify:o},{regex:m,indices:I,postModify:l},{regex:M,indices:{bucket:1,path:2},postModify:l}];for(let E=0;E<T.length;E++){const K=T[E],te=K.regex.exec(e);if(te){const kt=te[K.indices.bucket];let ne=te[K.indices.path];ne||(ne=""),r=new w(kt,ne),K.postModify(r);break}}if(r==null)throw kr(e);return r}}class Ur{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(t,e,n){let r=1,s=null,o=null,i=!1,a=0;function c(){return a===2}let l=!1;function f(...y){l||(l=!0,e.apply(null,y))}function p(y){s=setTimeout(()=>{s=null,t(m,c())},y)}function g(){o&&clearTimeout(o)}function m(y,...M){if(l){g();return}if(y){g(),f.call(null,y,...M);return}if(c()||i){g(),f.call(null,y,...M);return}r<64&&(r*=2);let T;a===1?(a=2,T=0):T=(r+Math.random())*1e3,p(T)}let I=!1;function $(y){I||(I=!0,g(),!l&&(s!==null?(y||(a=2),clearTimeout(s),p(0)):y||(a=1)))}return p(0),o=setTimeout(()=>{i=!0,$(!0)},n),$}function $r(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mr(t){return t!==void 0}function Fr(t){return typeof t=="object"&&!Array.isArray(t)}function ve(t){return typeof t=="string"||t instanceof String}function Ge(t){return Ae()&&t instanceof Blob}function Ae(){return typeof Blob<"u"&&!Ft()}function ye(t,e,n,r){if(r<e)throw we(`Invalid value for '${t}'. Expected ${e} or greater.`);if(r>n)throw we(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ee(t,e,n){let r=e;return n==null&&(r=`https://${e}`),`${n}://${r}/v0${t}`}function wt(t){const e=encodeURIComponent;let n="?";for(const r in t)if(t.hasOwnProperty(r)){const s=e(r)+"="+e(t[r]);n=n+s+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(e,n){this._service=e,n instanceof w?this._location=n:this._location=w.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new U(e,n)}get root(){const e=new w(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return It(this._location.path)}get storage(){return this._service}get parent(){const e=rs(this._location.path);if(e===null)return null;const n=new w(this._location.bucket,e);return new U(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw Nr(e)}}function Ts(t,e,n){t._throwIfRoot("uploadBytes");const r=Es(t.storage,t._location,Tt(),new R(e,!0),n);return t.storage.makeRequestWithTokens(r,Oe).then(s=>({metadata:s,ref:t}))}function vs(t){const e={prefixes:[],items:[]};return At(t,e).then(()=>e)}async function At(t,e,n){const s=await As(t,{pageToken:n});e.prefixes.push(...s.prefixes),e.items.push(...s.items),s.nextPageToken!=null&&await At(t,e,s.nextPageToken)}function As(t,e){e!=null&&typeof e.maxResults=="number"&&ye("options.maxResults",1,1e3,e.maxResults);const n=e||{},r=_s(t.storage,t._location,"/",n.pageToken,n.maxResults);return t.storage.makeRequestWithTokens(r,Oe)}function Rs(t){t._throwIfRoot("getDownloadURL");const e=bs(t.storage,t._location,Tt());return t.storage.makeRequestWithTokens(e,Oe).then(n=>{if(n===null)throw Pr();return n})}function Cs(t,e){const n=ss(t._location.path,e),r=new w(t._location.bucket,n);return new U(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
